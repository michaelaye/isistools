...
| `isistools csm2map` | CSM-based map projection (ISIS cam2map replacement) |
| `isistools csm2map-compare` | Pixel-level comparison of csm2map vs ISIS cam2map outputs |
